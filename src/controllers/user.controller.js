...
import asyncHandler from "../utils/asyncHandler.js"                         //import {asyncHandler} from "../utils/asyncHandler.js"                                                          //import asyncHandler from "../utils/asyncHandler.js"
...
const registerUser = asyncHandler( async(req, res) => {
    ...
    // return response
  console.log("register   register    resigster")
    ...
    console.log("coverImage localpath"+coverImageLocalPath);
...
const changeCurrentPassword = asyncHandler(async(req, res) => {
  ...
  console.log("in chage current password");
